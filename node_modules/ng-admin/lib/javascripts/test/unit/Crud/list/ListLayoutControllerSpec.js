...
describe('ListLayoutController', function () {
    ...
    describe('getCurrentSearchParam', function () {
        ...
        it('should add pinned filter defaultValue if not already set', function () {
            ...
            expect((0, _ListLayoutController.getCurrentSearchParam)(location, filters)).toEqual({ name: 'mapped name for doe', firstname: 'mapped firstname for default value for firstname' });
        });
